...
local bar1 = CreateFrame("Frame", "ThinKrUI_MainMenuBar", UIParent, "SecureHandlerStateTemplate")
bar1:SetWidth(323)
bar1:SetHeight(26)
...
local bar2 = CreateFrame("Frame", "ThinKrUI_MultiBarBottomLeft", UIParent, "SecureHandlerStateTemplate")
bar2:SetWidth(323)
bar2:SetHeight(26)
...
local bar3 = CreateFrame("Frame", "ThinKrUI_MultiBarBottomRight", UIParent, "SecureHandlerStateTemplate")
bar3:SetWidth(323)
bar3:SetHeight(26)
...
local bar4 = CreateFrame("Frame", "ThinKrUI_MultiBarRight", UIParent, "SecureHandlerStateTemplate")
bar4:SetHeight(323)
bar4:SetWidth(26)
...
local bar5 = CreateFrame("Frame", "ThinKrUI_MultiBarLeft", UIParent, "SecureHandlerStateTemplate")
bar5:SetHeight(323)
bar5:SetWidth(26)
...
local override = CreateFrame("Frame", "ThinKrUI_OverrideBar", UIParent, "SecureHandlerStateTemplate")
...
local petbar = CreateFrame("Frame", "ThinKrUI_PetBar", UIParent, "SecureHandlerStateTemplate")
...
local stancebar = CreateFrame("Frame", "ThinKrUI_StanceBar", UIParent, "SecureHandlerStateTemplate")
...
if C.actionbars.rightbars_mouseover then
	...
	local function showButtonsFlyout()
		...
		if frame and (frame == ThinKrUI_MultiBarLeft or frame == ThinKrUI_MultiBarRight) then
			showButtons()
		end
	end
...
local barextra = CreateFrame("Frame", "ThinKrUI_ExtraActionBar", UIParent, "SecureHandlerStateTemplate")
...
local leave = CreateFrame("Frame", "ThinKrUI_LeaveVehicle", UIParent, "SecureHandlerStateTemplate")
leave:SetSize(18, 18)
...
if not C.bags.enable and not C.actionbars.enable then
	for i = 0, 3 do
		_G["CharacterBag"..i.."Slot"]:SetParent(ThinKrUIHider)
	end
end
