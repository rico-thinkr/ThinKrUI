...
-- 	local helm = CreateFrame("CheckButton", "ThinKrUI_HelmCheckBox", PaperDollFrame, "OptionsCheckButtonTemplate")
-- 	helm:SetSize(22, 22)
...
-- 	local cloak = CreateFrame("CheckButton", "ThinKrUI_CloakCheckBox", PaperDollFrame, "OptionsCheckButtonTemplate")
-- 	cloak:SetSize(22, 22)
