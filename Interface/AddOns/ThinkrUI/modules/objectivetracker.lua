...
hooksecurefunc("ObjectiveTracker_Collapse", function()
	...
	ThinKrUIConfig.objectiveTracker.collapsed = true
end)

hooksecurefunc("ObjectiveTracker_Expand", function()
	minimizeButton.plus:Hide()
	ThinKrUIConfig.objectiveTracker.collapsed = false
end)
...
F.RegisterEvent("VARIABLES_LOADED", function()
	if not ThinKrUIConfig.objectiveTracker then ThinKrUIConfig.objectiveTracker = {} end

	if C.quests.rememberObjectiveTrackerState and (ThinKrUIConfig.objectiveTracker.collapsed or C.quests.alwaysCollapseObjectiveTracker) then
