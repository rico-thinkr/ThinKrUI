...
local f = CreateFrame("Frame", "ThinKrUI_InstallFrame", UIParent)
f:SetSize(400, 400)
f:SetPoint("CENTER")
...
credits:SetText("ThinKrUI by Lightsword @ Argent Dawn - EU / Haleth on wowinterface.com")
...
local option1 = CreateFrame("Button", "ThinKrUI_Install_Option1", f, "UIPanelButtonTemplate")
option1:SetPoint("BOTTOMLEFT", f, "BOTTOMLEFT", 20, 20)
option1:SetSize(128, 25)

local option2 = CreateFrame("Button", "ThinKrUI_Install_Option2", f, "UIPanelButtonTemplate")
option2:SetPoint("BOTTOMRIGHT", f, "BOTTOMRIGHT", -20, 20)
option2:SetSize(128, 25)

local close = CreateFrame("Button", "ThinKrUI_Install_CloseButton", f, "UIPanelCloseButton")
...
local tut5 = function()
	...
	body:SetText("Lastly, ThinKrUI includes useful slash commands. Below is a list.\n\n|cff00c1ff/ThinKrUI|r brings up a list of UI-specific commands (you might want to try this now). |cff00c1ff/en|r and |cff00c1ff/dis|r are used to quickly enable and disable addons. |cff00c1ff/rl|r reloads the UI.\n\n|cff00c1ff/rc|r initiates a ready check. |cff00c1ff/rolepoll|r or |cff00c1ff/rolecheck|r initiates a role check.\n\n|cff00c1ff/gm|r toggles the Help frame. |cff00c1ff/vol|r lets you set the master volume (0-1).")
...
local tut2 = function()
	...
	body:SetText("ThinKrUI includes an embedded version of oUF. This handles all of the unit frames on the screen, the buffs and debuffs, and the class-specific elements like Holy Power.\n\nIf you play as a healer, you may want to enable healer unit frames. Type |cff00c1ff/ThinKrUI dps/heal(er)|r to switch between layouts.\n\nThe source code for the unit frames is located in ThinKrUI/scripts/unitframes.lua. If you're any good with lua, you can edit them there.\n\nMost of the basics can be changed from the in-game options, to make it easier.")
