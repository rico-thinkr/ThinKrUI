...
if IsAddOnLoaded("Aurora") then
	print("ThinKrUI includes an efficient built-in version of Aurora.")
	...
	if addon == "ThinKrUI" then
		...
		for i = 1, #bds do
			...
			if bd then
				...
				print("ThinKrUI: "..bds[i].." was not found.")
			end
		end
		...
		for i = 1, #lightbds do
			...
			if bd then
				...
				print("ThinKrUI: "..lightbds[i].." was not found.")
			end
		end
		...
		for i = 1, #scrollbars do
			...
			if scrollbar then
				...
				print("ThinKrUI: "..scrollbars[i].." was not found.")
			end
		end
		...
		for i = 1, #radiobuttons do
			...
			if radiobutton then
				...
				print("ThinKrUI: "..radiobuttons[i].." was not found.")
			end
		end
		...
		local microButtons = {TalentMicroButtonAlert, CollectionsMicroButtonAlert}
			...
			button:SetPoint("BOTTOM", ThinKrUI_MultiBarBottomRight, "TOP", 0, 12)
		...
		for i = 1, #buttons do
			...
			if reskinbutton then
				...
				print("ThinKrUI: "..buttons[i].." was not found.")
			end
		end
