...
local holder = CreateFrame("Frame", nil, ThinKrUIMenubar)
...
ThinKrUIStatsButton:SetScript("OnUpdate", function(self, elapsed)
	last = last + elapsed
...
ThinKrUIStatsButton:HookScript("OnEnter", function()
...
ThinKrUIStatsButton:HookScript("OnLeave", function()
	GameTooltip:Hide()
	n, total = 0, 0
	wipe(addons)
end)
